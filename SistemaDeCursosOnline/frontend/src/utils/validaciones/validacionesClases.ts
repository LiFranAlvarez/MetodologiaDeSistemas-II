...
export const claseSchema = z.object({
  ...
  // Estos campos tienen valores por defecto en el backend (Mongoose)
  estado: z.enum(["PENDIENTE", "DISPONIBLE"]).default("PENDIENTE").optional(),
  fecha: z.string().optional(), // No es un campo del formulario, pero lo incluimos para el tipo Clase
  
  // linkGrabacion es opcional
